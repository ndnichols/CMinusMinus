// This module walks the CMM AST tree, recording variable and function types
// and checking their use.
// It's gross, but `analyze` also currently does the generation. That's
// because we need to know the variable types to do the generation correctly,
// and that information is all stored on the context.
